...
# The bank wants to calculate the total account balance for each AccountType by grouping the records based on AccountType 
# and identify which account type is attracting the highest total deposits from customers
SELECT 
    AccountType,
